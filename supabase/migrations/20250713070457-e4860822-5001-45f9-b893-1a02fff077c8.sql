...
-- Update orders policies first, then modify the table
...
-- Now safely drop the buyer_id column and add user_id
ALTER TABLE public.orders DROP COLUMN IF EXISTS buyer_id CASCADE;
